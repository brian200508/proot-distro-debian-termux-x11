...
proot-distro login ubuntu --user $user_name -- sudo apt update -y
proot-distro login ubuntu --user $user_name -- sudo apt install -y build-essential curl gh git lsb-release wget pgp python-is-python3 python3-venv python3-pip
wait_for_key
